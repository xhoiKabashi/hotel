...
const { homeContent } = require("../../models/edit/contentSchema");
const upload = require("../../utils/multer");
const { homeHeader } = require("../../models/edit/headerSchema");
...
homePage.post(
  ...
  async (request, response) => {
    try {
      const fieldsToUpdate = ["title", "h3Text", "position"];
...
//  Get Header
homePage.get("/home-header", (request, response) => {
...
// Get Content
homePage.get("/home-content", (request, response) => {
  try {
